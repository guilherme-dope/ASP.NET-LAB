...
namespace Sistema_Venda_SI.Model.Models
{
    public partial class DBSISTEMASContext : DbContext
    {
       ...
       => optionsBuilder.UseSqlServer("Data Source=DXPX\\SQLEXPRESS;Initial Catalog=DBSISTEMAS;Integrated Security=True;TrustServerCertificate=True");
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Endereco>(entity =>
            {
                ...
                entity.HasOne(d => d.EndCodigoClienteNavigation)
            ...
            modelBuilder.Entity<EntradaProduto>(entity =>
            {
                ...
                entity.HasOne(d => d.EnpCodigoEntradaNavigation)
                    .WithMany(p => p.EntradaProduto)
                    .HasForeignKey(d => d.EnpCodigoEntrada)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_ENTRADA_PRODUTO_ENTRADA");

                entity.HasOne(d => d.EnpCodigoProdutoNavigation)
                    .WithOne(p => p.EntradaProduto)
            ...
            modelBuilder.Entity<Parcelas>(entity =>
            {
                ...
                entity.HasOne(d => d.ParCodigoVendaNavigation)
            ...
            modelBuilder.Entity<Produto>(entity =>
            {
                ...
                entity.HasOne(d => d.ProCodigoTipoProdutoNavigation)
                    .WithMany(p => p.Produto)
                    .HasForeignKey(d => d.ProCodigoTipoProduto)
                    .HasConstraintName("FK_PRODUTO_TIPO_PRODUTO");

                entity.HasOne(d => d.ProCodigoUnidadeNavigation)
                    .WithMany(p => p.Produto)
            ...
            modelBuilder.Entity<Venda>(entity =>
            {
                ...
                entity.HasOne(d => d.VenCodigoClienteNavigation)
                    .WithMany(p => p.Venda)
                    .HasForeignKey(d => d.VenCodigoCliente)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_VENDA_CLIENTE");

                entity.HasOne(d => d.VenCodigoTipoPagamentoNavigation)
                    .WithMany(p => p.Venda)
                    .HasForeignKey(d => d.VenCodigoTipoPagamento)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_VENDA_TIPO_PAGAMENTO");

                entity.HasMany(d => d.ItvCodigoProduto)
                    .WithMany(p => p.ItvCodigoVenda)
                    .UsingEntity<Dictionary<string, object>>(
                        "ItensVenda",
                        l => l.HasOne<Produto>().WithMany().HasForeignKey("ItvCodigoProduto").OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_ITENS_VENDA_PRODUTO"),
                        r => r.HasOne<Venda>().WithMany().HasForeignKey("ItvCodigoVenda").OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_ITENS_VENDA_VENDA"),
                        j =>
                        {
